...
Shader "TriForge Assets/Medieval Weapons/Shield (HDRP)"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 texCoord1_g5 = packedInput.interp04.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord1_g4 = packedInput.interp04.xy * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode95 = tex2D( _Layer2DecalMask, ( ( (float2( -0.5,-0.5 ) + (texCoord1_g4 - float2( 0,0 )) * (float2( 0.5,0.5 ) - float2( -0.5,-0.5 )) / (float2( 1,1 ) - float2( 0,0 ))) * _Layer2Size ) + _Layer2Offset ) );
				...
				float2 texCoord1_g6 = packedInput.interp04.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord1_g7 = packedInput.interp04.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 texCoord16 = packedInput.interp04.xy * float2( 1,1 ) + float2( 0,0 );
				...
				surfaceDescription.Metallic = ( _Metallicstrength * tex2DNode2.r );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 texCoord1_g5 = packedInput.ase_texcoord.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode47 = tex2D( _Layer1DecalMask, ( ( (float2( -0.5,-0.5 ) + (texCoord1_g5 - float2( 0,0 )) * (float2( 0.5,0.5 ) - float2( -0.5,-0.5 )) / (float2( 1,1 ) - float2( 0,0 ))) * _Layer1Size ) + _Layer1Offset ) );
				float4 lerpResult87 = lerp( _Layer1Color1 , _Layer1Color2 , tex2DNode47.r);
				float4 lerpResult88 = lerp( lerpResult87 , _Layer1Color3 , tex2DNode47.g);
				float4 lerpResult89 = lerp( lerpResult88 , _Layer1Color4 , tex2DNode47.b);
				float2 texCoord1_g4 = packedInput.ase_texcoord.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode95 = tex2D( _Layer2DecalMask, ( ( (float2( -0.5,-0.5 ) + (texCoord1_g4 - float2( 0,0 )) * (float2( 0.5,0.5 ) - float2( -0.5,-0.5 )) / (float2( 1,1 ) - float2( 0,0 ))) * _Layer2Size ) + _Layer2Offset ) );
				float4 lerpResult90 = lerp( _Layer2Color1 , _Layer2Color2 , tex2DNode95.r);
				float4 lerpResult96 = lerp( lerpResult90 , _Layer2Color3 , tex2DNode95.g);
				float4 lerpResult97 = lerp( lerpResult96 , _Layer2Color4 , tex2DNode95.b);
				float4 lerpResult98 = lerp( lerpResult89 , lerpResult97 , tex2DNode95.a);
				float2 texCoord1_g6 = packedInput.ase_texcoord.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode112 = tex2D( _Layer3DecalMask, ( ( (float2( -0.5,-0.5 ) + (texCoord1_g6 - float2( 0,0 )) * (float2( 0.5,0.5 ) - float2( -0.5,-0.5 )) / (float2( 1,1 ) - float2( 0,0 ))) * _Layer3Size ) + _Layer3Offset ) );
				float4 lerpResult111 = lerp( _Layer3Color1 , _Layer3Color2 , tex2DNode112.r);
				float4 lerpResult110 = lerp( lerpResult111 , _Layer3Color3 , tex2DNode112.g);
				float4 lerpResult108 = lerp( lerpResult110 , _Layer3Color4 , tex2DNode112.b);
				float4 lerpResult113 = lerp( lerpResult98 , lerpResult108 , tex2DNode112.a);
				float2 texCoord1_g7 = packedInput.ase_texcoord.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode128 = tex2D( _Layer4DecalMask, ( ( (float2( -0.5,-0.5 ) + (texCoord1_g7 - float2( 0,0 )) * (float2( 0.5,0.5 ) - float2( -0.5,-0.5 )) / (float2( 1,1 ) - float2( 0,0 ))) * _Layer4Size ) + _Layer4Offset ) );
				float4 lerpResult131 = lerp( _Layer4Color1 , _Layer4Color2 , tex2DNode128.r);
				float4 lerpResult134 = lerp( lerpResult131 , _Layer4Color3 , tex2DNode128.g);
				float4 lerpResult135 = lerp( lerpResult134 , _Layer4Color4 , tex2DNode128.b);
				float4 lerpResult136 = lerp( lerpResult113 , lerpResult135 , tex2DNode128.a);
				float4 lerpResult70 = lerp( _DecalBackgroundColor , lerpResult136 , saturate( pow( ( tex2DNode47.a + tex2DNode95.a + tex2DNode112.a + tex2DNode128.a ) , 7.09 ) ));
				float2 texCoord16 = packedInput.ase_texcoord.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode11 = tex2D( _DecalMask, texCoord16 );
				float4 lerpResult12 = lerp( tex2D( _MainTex, uv_MainTex ) , lerpResult70 , tex2DNode11);
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode2 = tex2D( _MaskMap, uv_MaskMap );
				float temp_output_5_0 = ( _Smoothnessstrength * tex2DNode2.a );
				float2 texCoord16 = packedInput.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
				float4 tex2DNode11 = tex2D( _DecalMask, texCoord16 );
				float lerpResult19 = lerp( temp_output_5_0 , ( temp_output_5_0 * _DecalBackgroundRoughness ) , tex2DNode11.r);
...
/*ASEBEGIN
Version=18921
7;12;1920;1007;1755.57;6.635983;1.218659;True;False
Node;AmplifyShaderEditor.RangedFloatNode;115;-4707.693,1927.353;Float;False;Property;_Layer2Size;Layer 2 Size;21;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;116;-4720.693,2013.353;Float;False;Property;_Layer2Offset;Layer 2 Offset;22;0;Create;True;0;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;100;-4724.639,845.2894;Float;False;Property;_Layer1Size;Layer 1 Size;14;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;102;-4737.639,931.2894;Float;False;Property;_Layer1Offset;Layer 1 Offset;15;0;Create;True;0;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;118;-4708.94,3024.648;Float;False;Property;_Layer3Size;Layer 3 Size;28;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;119;-4720.063,3110.648;Float;False;Property;_Layer3Offset;Layer 3 Offset;29;0;Create;True;0;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;27;-4060.083,1222.236;Float;False;Property;_Layer1Color2;Layer 1 Color 2;11;0;Create;True;0;0;0;False;0;False;0.03448272,1,0,0;1,0.5261962,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;47;-4131.633,808.5133;Inherit;True;Property;_Layer1DecalMask;Layer 1 Decal Mask;9;0;Create;True;0;0;0;False;0;False;-1;None;e43c7db334601294f9ee66e3dab40926;True;2;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;125;-4686.76,4115.112;Float;False;Property;_Layer4Size;Layer 4 Size;35;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;95;-4137.787,1916.6;Inherit;True;Property;_Layer2DecalMask;Layer 2 Decal Mask;16;0;Create;True;0;0;0;False;0;False;-1;None;None;True;2;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;94;-4068.426,2131.153;Float;False;Property;_Layer2Color1;Layer 2 Color 1;17;0;Create;True;0;0;0;False;0;False;0,0.006896496,1,0;0,0.006896496,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;126;-4699.76,4201.112;Float;False;Property;_Layer4Offset;Layer 4 Offset;36;0;Create;True;0;0;0;False;0;False;0.5,0.5;0.5,0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.ColorNode;26;-4062.272,1023.067;Float;False;Property;_Layer1Color1;Layer 1 Color 1;10;0;Create;True;0;0;0;False;0;False;0,0.006896496,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;107;-4041.579,3223.687;Float;False;Property;_Layer3Color1;Layer 3 Color 1;24;0;Create;True;0;0;0;False;0;False;0,0.006896496,1,0;0,0.006896496,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;28;-4052.612,1451.621;Float;False;Property;_Layer1Color3;Layer 1 Color 3;12;0;Create;True;0;0;0;False;0;False;0.8897059,0.6074544,0,0;0.8897059,0.6074544,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;109;-4039.389,3428.093;Float;False;Property;_Layer3Color2;Layer 3 Color 2;25;0;Create;True;0;0;0;False;0;False;0.03448272,1,0,0;0.03448272,1,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;128;-4090.637,4099.599;Inherit;True;Property;_Layer4DecalMask;Layer 4 Decal Mask;30;0;Create;True;0;0;0;False;0;False;-1;None;None;True;2;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;29;-4048.992,1675.203;Float;False;Property;_Layer1Color4;Layer 1 Color 4;13;0;Create;True;0;0;0;False;0;False;0,0.7824035,0.8161765,0;0,0.7824035,0.8161765,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;93;-4055.146,2781.165;Float;False;Property;_Layer2Color4;Layer 2 Color 4;20;0;Create;True;0;0;0;False;0;False;0,0.7824035,0.8161765,0;0,0.7824035,0.8161765,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;106;-4031.918,3652.24;Float;False;Property;_Layer3Color3;Layer 3 Color 3;26;0;Create;True;0;0;0;False;0;False;0.8897059,0.6074544,0,0;0.8897059,0.6074544,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;130;-4021.275,4314.151;Float;False;Property;_Layer4Color1;Layer 4 Color 1;31;0;Create;True;0;0;0;False;0;False;0,0.006896496,1,0;0,0.006896496,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;129;-4019.085,4518.558;Float;False;Property;_Layer4Color2;Layer 4 Color 2;32;0;Create;True;0;0;0;False;0;False;0.03448272,1,0,0;0.03448272,1,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;132;-4011.614,4746.133;Float;False;Property;_Layer4Color3;Layer 4 Color 3;33;0;Create;True;0;0;0;False;0;False;0.8897059,0.6074544,0,0;0.8897059,0.6074544,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;105;-4028.298,3873.699;Float;False;Property;_Layer3Color4;Layer 3 Color 4;27;0;Create;True;0;0;0;False;0;False;0,0.7824035,0.8161765,0;0,0.7824035,0.8161765,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;133;-4007.994,4964.163;Float;False;Property;_Layer4Color4;Layer 4 Color 4;34;0;Create;True;0;0;0;False;0;False;0,0.7824035,0.8161765,0;0,0.7824035,0.8161765,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;2;-1055.767,354.19;Inherit;True;Property;_MaskMap;Mask Map;1;0;Create;True;0;0;0;False;0;False;-1;None;2bb0fa8d316615a4698a5b57181b20eb;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;15;-4087.556,276.5779;Float;False;Property;_DecalBackgroundColor;Decal Background Color;7;0;Create;True;0;0;0;False;0;False;0.7058823,0.7058823,0.7058823,0;0.4339623,0.165488,0.1412424,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-4126.155,464.8506;Float;False;Property;_DecalBackgroundRoughness;Decal Background Roughness;8;0;Create;True;0;0;0;False;0;False;0.5;1.53;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-2771.719,-555.4841;Inherit;True;Property;_MainTex;Albedo;0;0;Create;False;0;0;0;False;0;False;-1;None;b23e4c5d301cf4147ab6c15923dda265;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;11;-2771.597,-336.8877;Inherit;True;Property;_DecalMask;Decal Mask;6;0;Create;True;0;0;0;False;0;False;-1;None;7e9fc35e5716e384389495163d7991d6;True;2;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;7;-1042.164,873.6585;Inherit;True;Property;_Occlusion;Occlusion;5;0;Create;True;0;0;0;False;0;False;-1;None;789158e67e7365b4fb75f20c8a7046d5;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;9;-1040.37,623.5016;Inherit;True;Property;_Normal;Normal;4;0;Create;True;0;0;0;False;0;False;-1;None;02a10febf0dcb0b448c4f7b5fbef24eb;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;137;1;9;0
WireConnection;137;4;3;0
WireConnection;137;7;19;0
WireConnection;137;8;7;2
ASEEND*/
//CHKSM=A35A53B5FB2E67C85421B3CB41A5E0BC3003B53E